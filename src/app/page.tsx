...
export default function GalleryPage() {
    ...
    return (
      <div className="space-y-12">
        <div className="text-center space-y-4">
          <Skeleton className="h-10 md:h-12 w-3/4 mx-auto bg-muted/30" />
          <Skeleton className="h-5 md:h-6 w-full max-w-2xl mx-auto bg-muted/30" />
        </div>
        <div className="flex justify-center">
          <Skeleton className="h-10 w-1/2 bg-muted/30" />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {[...Array(8)].map((_, i) => (
            <Skeleton key={i} className="h-64 w-full bg-muted/30" />
          ))}
        </div>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <Skeleton className="h-8 w-1/2 mb-4 bg-muted/30" />
          ...
          <Skeleton className="h-80 w-full rounded-lg bg-muted/30" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full space-y-12 md:space-y-16">
      <section className="relative text-center py-16 md:py-24 min-h-[400px] md:min-h-[550px] flex flex-col justify-center items-center rounded-lg overflow-hidden shadow-xl">
        <Image
          src="https://images.unsplash.com/photo-1523438097201-512ae7d59c44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHx3ZWRkaW5nJTIwZWxlZ2FudCUyMGJhY2tncm91bmR8ZW58MHx8fHwxNzEwMzg5MjAyfDA&ixlib=rb-4.1.0&q=80&w=1920"
          alt="Elegant wedding ceremony background with floral decorations"
          fill
          sizes="100vw"
          style={{objectFit:"cover"}}
          className="z-0 opacity-40" 
          data-ai-hint="elegant wedding floral"
          priority
        />
        <div className="relative z-10 p-6 bg-black/50 rounded-xl shadow-2xl backdrop-blur-sm">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-headline text-white mb-6" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.6)'}}>
            Welcome to Jayant Studio
          </h1>
          <p className="text-xl md:text-2xl text-neutral-100 mb-8 max-w-3xl mx-auto" style={{textShadow: '1px 1px 3px rgba(0,0,0,0.5)'}}>
          ...
          <Button size="lg" variant="default" asChild className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg px-8 py-3 shadow-md">
      ...
      <section id="why-us" className="py-8 md:py-12 bg-background/70 rounded-lg p-6 md:p-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 text-center">
          <div className="flex flex-col items-center p-6 bg-card rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1">
            <Heart className="h-10 w-10 md:h-12 md:w-12 text-accent mb-4" />
          ...
          <div className="flex flex-col items-center p-6 bg-card rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1">
            <Camera className="h-10 w-10 md:h-12 md:w-12 text-accent mb-4" />
          ...
          <div className="flex flex-col items-center p-6 bg-card rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1 sm:col-span-2 lg:col-span-1">
            <Smile className="h-10 w-10 md:h-12 md:w-12 text-accent mb-4" />
      ...
      <section id="portfolio" className="py-8 md:py-12">
        ...
        />
        {allPhotos.length > 0 || !selectedCategoryId ? (
          <PhotoGrid photos={filteredPhotos} onPhotoClick={handlePhotoClick} />
        ) : (
           <p className="text-center text-muted-foreground text-lg col-span-full mt-8">
            No photos yet in this category. Check back soon or select another category!
          </p>
        )}
      ...
      <section id="services" className="py-8 md:py-12 bg-card rounded-lg p-6 md:p-8 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="grid grid-cols-1 gap-6 md:gap-8">
            <div className="flex flex-col items-center text-center p-6 border border-border rounded-lg hover:shadow-lg transition-shadow bg-card/50">
              <Users className="h-10 w-10 md:h-12 md:w-12 text-accent mb-4" />
            ...
            <div className="flex flex-col items-center text-center p-6 border border-border rounded-lg hover:shadow-lg transition-shadow bg-card/50">
              <Award className="h-10 w-10 md:h-12 md:w-12 text-accent mb-4" />
            ...
            <div className="flex flex-col items-center text-center p-6 border border-border rounded-lg hover:shadow-lg transition-shadow bg-card/50">
              <CalendarDays className="h-10 w-10 md:h-12 md:w-12 text-accent mb-4" />
      ...
      <section id="approach" className="py-8 md:py-12">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center bg-card p-6 md:p-12 rounded-lg shadow-lg">
          <div className="order-2 md:order-1">
            ...
            <ul className="space-y-3 text-sm md:text-base text-card-foreground/70 mb-6 list-disc list-inside marker:text-accent">
            ...
            <Button size="lg" variant="outline" asChild className="border-accent text-accent hover:bg-accent hover:text-accent-foreground text-lg px-8 py-3">
      ...
      <section id="contact" className="py-12 md:py-16 bg-card rounded-lg p-6 md:p-8 shadow-lg text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          <a href="tel:+919827314661" className="text-xl md:text-2xl text-foreground hover:text-accent transition-colors flex items-center gap-3 p-3 border border-border rounded-lg hover:border-accent shadow-sm hover:shadow-md">
          ...
          <a 
            ...
            className="text-xl md:text-2xl text-foreground hover:text-accent transition-colors flex items-center gap-3 p-3 border border-border rounded-lg hover:border-accent shadow-sm hover:shadow-md"
          >
            <InstagramIcon className="h-6 w-6" /> Follow on Instagram
          </a>
        </div>
         <Button size="lg" variant="secondary" asChild className="mt-10 text-lg px-8 py-3">
      ...
      {currentPhoto && (
        <Lightbox
          ...
          hasNext={filteredPhotos.length > 1 && filteredPhotos.length > 0} 
          hasPrev={filteredPhotos.length > 1 && filteredPhotos.length > 0}
        />
      )}
    </div>
  );
